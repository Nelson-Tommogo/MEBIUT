...
const CaseStudy = () => {
    ...
    const [active, setActive] = useState([true, false, false, false, false]); // Ensure consistency
    ...
    const activeNav = (i) => {
        let temp = [false, false, false, false, false]; // Matching the number of categories
        temp[i] = true;
        setActive([...temp]);
    };
